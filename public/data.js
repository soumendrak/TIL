...
window.TILS = [
  {
    ...
    "content": "<h2>What is Kintsugi</h2>\n<p>Kintsugi (金継ぎ, &quot;golden joinery&quot;) is the Japanese art of repairing broken pottery with urushi lacquer dusted with powdered gold. The crack is not hidden — it is highlighted. The repaired bowl is often considered more valuable than the original because the gold seam makes it structurally unique: no two breaks are the same.[^1]</p>\n<p>The philosophy draws on wabi-sabi: imperfection and impermanence are not flaws to conceal but realities to embrace.[^2]</p>\n<h2>Why not hide the crack?</h2>\n<p>The common explanation (&quot;it&#39;s about history&quot;) is sentimental and incomplete. Four deeper reasons:</p>\n<table>\n<thead>\n<tr>\n<th>Question</th>\n<th>Surface answer</th>\n<th>Deeper truth</th>\n</tr>\n</thead>\n<tbody><tr>\n<td>&quot;Why not hide the crack?&quot;</td>\n<td>&quot;It&#39;s about history&quot;</td>\n<td>Urushi lacquer is structurally tougher than clay — the gold seam is physically the strongest part of the vessel[^1]</td>\n</tr>\n<tr>\n<td>&quot;Doesn&#39;t &#39;like new&#39; make it last longer?&quot;</td>\n<td>&quot;Perfection is temporary&quot;</td>\n<td>A perfect-looking bowl gets wrapped and shelved. A visible crack frees the object for daily use — no illusion to protect[^2]</td>\n</tr>\n<tr>\n<td>&quot;Isn&#39;t history just sentiment?&quot;</td>\n<td>&quot;The crack tells a story&quot;</td>\n<td>The seam makes the object <strong>irreplaceable</strong> — no factory can replicate a unique break pattern</td>\n</tr>\n<tr>\n<td>&quot;Doesn&#39;t hiding protect the object?&quot;</td>\n<td>&quot;Honesty is moral&quot;</td>\n<td>Hiding requires a permanent lie. Visible repair eliminates performance anxiety entirely</td>\n</tr>\n</tbody></table>\n<h2>How this maps to AI observability</h2>\n<p>An AI agent fails in production. You have two responses:</p>\n<p><strong>Hide the crack</strong> — treat the failure as an exception, patch the immediate symptom, move on. No trace, no logging enhancement, no postmortem. The system looks &quot;unbroken&quot; but the underlying fragility remains.</p>\n<p><strong>Fill with gold</strong> — instrument the failure: capture the trace, log the token usage, record the tool calls, run an eval on the output, write a postmortem. The failure becomes visible, named, and analyzed.</p>\n<p>This is the exact structural parallel to Kintsugi:</p>\n<pre><code class=\"language-mermaid\">flowchart LR\n    F[&quot;System failure&lt;br/&gt;(The crack)&quot;] --&gt; H[&quot;Hide&lt;br/&gt;No tracing, no logging&lt;br/&gt;Pretend it didn&#39;t happen&lt;br/&gt;= breakage hidden under staples&quot;]\n    F --&gt; I[&quot;Illuminate&lt;br/&gt;OpenTelemetry traces&lt;br/&gt;Eval-driven debugging&lt;br/&gt;= Kintsugi gold seam&quot;]\n\n    I --&gt; RC[&quot;Root cause identified&quot;]\n    I --&gt; ID[&quot;Incident documented&quot;]\n    I --&gt; SI[&quot;System improved&quot;]\n    I --&gt; FU[&quot;Failure was useful&quot;]\n\n    H --&gt; RF[&quot;Repeat failure&quot;]\n    H --&gt; NL[&quot;No learning&quot;]\n    H --&gt; D[&quot;System degrades&quot;]\n\n    style F fill:#2d1b1b,stroke:#e94560,color:#222\n    style H fill:#2d1b1b,stroke:#555,color:#888\n    style I fill:#1a3d1a,stroke:#e94560,color:#222\n</code></pre>\n<p>A team that hides failures never builds institutional knowledge. Every incident is a surprise. A team that illuminates failures — with traces, evals, and observability infrastructure — turns every break into a gold seam. The system becomes stronger at the repaired point, and the knowledge is permanent.[^3]</p>\n<h2>The personal version</h2>\n<p>The same principle applies to a career narrative. Presenting an unbroken facade (everything went perfectly, every move was planned) creates fragility — one crack in the story and the whole thing looks suspect. A Kintsugi narrative (here&#39;s where I broke, here&#39;s what I filled it with) has nothing to hide.</p>\n<hr>\n<p>[^1]: Wikipedia, &quot;Kintsugi,&quot; <a href=\"https://en.wikipedia.org/wiki/Kintsugi\">https://en.wikipedia.org/wiki/Kintsugi</a>, verified 2026-07-04. Covers the philosophy, the three joinery styles, and urushi lacquer materials.</p>\n<p>[^2]: Wikipedia, &quot;Wabi-sabi,&quot; <a href=\"https://en.wikipedia.org/wiki/Wabi-sabi\">https://en.wikipedia.org/wiki/Wabi-sabi</a>, verified 2026-07-04. Andrew Juniper: wabi-sabi brings &quot;a sense of serene melancholy and a spiritual longing.&quot; Richard Powell: &quot;Nothing lasts, nothing is finished, and nothing is perfect.&quot;</p>\n<p>[^3]: Widescope project, soumendrak/widescope, <a href=\"https://github.com/soumendrak/widescope\">https://github.com/soumendrak/widescope</a>, verified 2026-07-04. WASM-based LLM trace viewer — a tool that makes agent failures visible rather than hiding them.</p>"
  },
  {
